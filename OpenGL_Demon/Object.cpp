...
void Object::SetVerticlesAndIndeсes(std::vector<float> verticesData, std::vector<int> indexData) {
	verticlesCount = verticesData.size();
...
void Object::Draw(Shader& shader) {
	...
	glDrawElements(GL_TRIANGLES, verticlesCount, GL_UNSIGNED_INT, 0);
	glBindVertexArray(0);
